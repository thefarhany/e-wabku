    ...
    <table class="table table-bordered">
      <thead>
        <tr class="text-center">
          ...
          <th class="align-middle" scope="col">Akun</th>
      ...
      <tbody>
        ...
        <tr class="text-center">
          ...
          <td class="align-middle">
            @if($d->validasi_ppk == "Disetujui" && $d->pdf_ssp_pajak)
            <span class="badge bagde-info"><a href="{{ Storage::url($d->pdf_spp) }}" target="_blank">PDF SPP</a></span>
            <span class="badge bagde-info"><a href="{{ Storage::url($d->pdf_ssp_pajak) }}" target="_blank">PDF SSP Pajak</a></span>
            @elseif($d->validasi_ppk == "Disetujui" && !$d->pdf_ssp_pajak)
            <span class="badge bagde-info"><a href="{{ Storage::url($d->pdf_spp) }}" target="_blank">PDF SPP</a></span>
            @else
            <span class="badge badge-warning">Belum Disetujui</span>
            @endif
          ...
          <td class="align-middle">
            @if($d->validasi_sp2d == "Disetujui")
            <span class="badge bagde-info"><a href="{{ Storage::url($d->pdf_sp2d) }}" target="_blank">PDF SP2D</a></span>
            @else
            <span class="badge badge-warning">Belum Disetujui</span>
            @endif
          </td>
